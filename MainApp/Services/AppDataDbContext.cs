...
namespace JeeshantPatelAssignment3.Services
{
    public class AppDataDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Invoice>().HasOne(i => i.PaymentTerms).WithMany().HasForeignKey(i => i.PaymentTermsId);
            modelBuilder.Entity<Invoice>().HasOne(i => i.Customer).WithMany(c => c.Invoices).HasForeignKey(i => i.CustomerId);
            modelBuilder.Entity<InvoiceLineItem>().HasOne(l => l.Invoice).WithMany(i => i.LineItems).HasForeignKey(i => i.InvoiceId);
        }
